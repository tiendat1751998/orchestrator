...
type Scheduler struct {
	...
	submitted map[contracts.TaskID]bool
...
func New(dispatch DispatchFunc, logger *slog.Logger) *Scheduler {
	return &Scheduler{
		...
		submitted:   make(map[contracts.TaskID]bool),
...
func (s *Scheduler) Reset() {
	...
	s.submitted = make(map[contracts.TaskID]bool)
